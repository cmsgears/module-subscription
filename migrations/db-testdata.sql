...
INSERT INTO `cmg_core_role` (`createdBy`,`modifiedBy`,`name`,`slug`,`homeUrl`,`type`,`description`,`icon`,`createdAt`,`modifiedAt`) VALUES 
	(1,1,'Subscription Manager','subscription-manager','dashboard','system','The role Subscription Manager is limited to manage subscriptions from admin.',NULL,'2014-10-11 14:22:54','2014-10-11 14:22:54');
...
INSERT INTO `cmg_core_permission` (`createdBy`,`modifiedBy`,`name`,`slug`,`type`,`description`,`icon`,`createdAt`,`modifiedAt`) VALUES 
	(1,1,'Subscription','subscription','system','The permission subscription is to manage subscriptions and subscribers from admin.',null,'2014-10-11 14:22:54','2014-10-11 14:22:54');
